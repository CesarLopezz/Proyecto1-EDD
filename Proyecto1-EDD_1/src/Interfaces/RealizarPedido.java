...
public class RealizarPedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Producto que desea adquirir:");

        Pedido.setBackground(new java.awt.Color(0, 0, 0));
        Pedido.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        Pedido.setForeground(new java.awt.Color(255, 255, 255));
        Pedido.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pantalla", "RAM", "Procesador", "Gráfica", "Placa", "Teclado", "Mouse", "Micrófono", "Audífonos", " " }));
        ...
        resumen.setBackground(new java.awt.Color(0, 0, 0));
        resumen.setColumns(20);
        resumen.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        ...
        jLabel7.setText("Resumen de compra:");

        comprar.setBackground(new java.awt.Color(0, 0, 0));
        comprar.setFont(new java.awt.Font("Century Gothic", 1, 12)); // NOI18N
        comprar.setForeground(new java.awt.Color(255, 255, 255));
        comprar.setText("Procesar compra");
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addComponent(Pedido, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(30, 30, 30)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String item = Pedido.getSelectedItem().toString();
        String cant = JOptionPane.showInputDialog("Ingrese la cantidad que desea");
        String almacen = JOptionPane.showInputDialog("Ingrese el almacen al cual desea pedir");
        try {
            int cantidad = Integer.parseInt(cant);
            resumen.append(cant + "-" + item + " "+ "Almacen: "+almacen+ "\n");
        } catch (Exception e) {
